...
| Test Case 8  | Deck `[card1, card2, card3]`, indices `3, 1, 0`                   | `IllegalArgumentException` (Only indices allowed given the deck size s are s - 1, s - 2, and s - 3) | :white_check_mark: | rearrangeTopThreeCards_ThreeCardsIndexThree_throwsIllegalArgumentException                |
| Test Case 9  | Deck `[card1, card2, card3, card4.1, card4.2]`, indices `3, 0, 2` | `IllegalArgumentException` (Only indices allowed given the deck size s are s - 1, s - 2, and s - 3) | :white_check_mark: | rearrangeTopThreeCards_FourCardsIndexZero_throwsIllegalArgumentException                  |
