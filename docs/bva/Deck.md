...
| Test Case 2  | Deck `[card1]`, indices `[0, 1]`                                  | `IllegalArgumentException` (Number of indices is larger than the deck size)                         | :white_check_mark: | rearrangeTopThreeCards_deckWithOneCardWithTwoIndices_throwsIllegalArgumentException       |
