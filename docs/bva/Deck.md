...
| Test Case 6  | Deck `[card1, card2, card3]`, indices `2, -1, 0`                  | `IllegalArgumentException` (Negative indices are not allowed)                                       | :white_check_mark: | rearrangeTopThreeCards_withNegativeSecondIndex_throwsIllegalArgumentException             |
| Test Case 7  | Deck `[card1, card2, card3]`, indices `2, 1, -1`                  | `IllegalArgumentException` (Negative indices are not allowed)                                       | :white_check_mark: | rearrangeTopThreeCards_withNegativeThirdIndex_throwsIllegalArgumentException              |
