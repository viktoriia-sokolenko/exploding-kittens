...
|              | System under test                                                 | Expected output / state transition                                                                  | Implemented? | Test name                                                                                 |
|--------------|-------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|--------------|-------------------------------------------------------------------------------------------|
| Test Case 1  | Deck `[]`, indices `[0, 1, 2]`                                    | `NoSuchElementException`                                                                            |              | rearrangeTopThreeCards_emptyDeck_throwsNoSuchElementException                             |
| Test Case 2  | Deck `[card1]`, indices `[0, 1]`                                  | `IllegalArgumentException` (Number of indices is larger than the deck size)                         |              | rearrangeTopThreeCards_deckWithOneCardWithTwoIndices_throwsIllegalArgumentException       |
| Test Case 3  | Deck `[card1, card2]`, indices `[0, 1, 2]`                        | `IllegalArgumentException` (Number of indices is larger than the deck size)                         |              | rearrangeTopThreeCards_deckWithTwoCardsWithThreeIndices_throwsIllegalArgumentException    |
| Test Case 4  | Deck `[card1, card2, card3]`, indices `[0, 1, 2, 3]`              | `IllegalArgumentException` (Number of indices is larger than the deck size)                         |              | rearrangeTopThreeCards_deckWithThreeCardsWithFourIndices_throwsIllegalArgumentException   |
| Test Case 5  | Deck `[card1, card2]`, indices `-1, 1`                            | `IllegalArgumentException` (Negative indices are not allowed)                                       |              | rearrangeTopThreeCards_withNegativeFirstIndex_throwsIllegalArgumentException              |
| Test Case 6  | Deck `[card1, card2, card3]`, indices `2, -1, 0`                  | `IllegalArgumentException` (Negative indices are not allowed)                                       |              | rearrangeTopThreeCards_withNegativeSecondIndex_throwsIllegalArgumentException             |
| Test Case 7  | Deck `[card1, card2, card3]`, indices `2, 1, -1`                  | `IllegalArgumentException` (Negative indices are not allowed)                                       |              | rearrangeTopThreeCards_withNegativeThirdIndex_throwsIllegalArgumentException              |
| Test Case 8  | Deck `[card1, card2, card3]`, indices `3, 1, 0`                   | `IllegalArgumentException` (Only indices allowed given the deck size s are s - 1, s - 2, and s - 3) |              | rearrangeTopThreeCards_deckWithThreeCardsWithIndexThree_throwsIllegalArgumentException    |
| Test Case 9  | Deck `[card1, card2, card3, card4.1, card4.2]`, indices `3, 0, 2` | `IllegalArgumentException` (Only indices allowed given the deck size s are s - 1, s - 2, and s - 3) |              | rearrangeTopThreeCards_deckWithFourCardsWithIndexZero_throwsIllegalArgumentException      |
| Test Case 10 | Deck `[card1, card2, card3, card4.1, card4.2]`, indices `1, 2, 3` | `IllegalArgumentException` (Only indices allowed given the deck size s are s - 1, s - 2, and s - 3) |              | rearrangeTopThreeCards_deckWithFourCardsWithIndexOne_throwsIllegalArgumentException       |
| Test Case 11 | Deck `[card1, card2, card3, card4.1, card4.2]`, indices `1, 2, 1` | `IllegalArgumentException` (Duplicate indices are not allowed)                                      |              | rearrangeTopThreeCards_withDuplicateFirstAndThirdIndices_throwsIllegalArgumentException   |
| Test Case 12 | Deck `[card1, card2]`, indices `0, 0`                             | `IllegalArgumentException` (Duplicate indices are not allowed)                                      |              | rearrangeTopThreeCards_withDuplicateFirstAndSecondIndices_throwsIllegalArgumentException  |
| Test Case 13 | Deck `[card1, card2, card3]`, indices `0, 2, 2`                   | `IllegalArgumentException` (Duplicate indices are not allowed)                                      |              | rearrangeTopThreeCards_withDuplicateSecondAndThirdIndices_throwsIllegalArgumentException  |
| Test Case 14 | Deck `[card1]`, indices `[0]`                                     | Deck `[card1]`                                                                                      |              | rearrangeTopThreeCards_deckWithOneCard_orderRemainsTheSame                                |
| Test Case 15 | Deck `[card1, card2]`, indices `[0, 1]`                           | Deck `[card1, card2]`                                                                               |              | rearrangeTopThreeCards_deckWithTwoCardsAndSameIndices_orderRemainsTheSame                 |
