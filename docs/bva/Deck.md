...
| Test Case 12 | Deck `[card1, card2]`, indices `0, 0`                             | `IllegalArgumentException` (Duplicate indices are not allowed)                | :white_check_mark: | rearrangeTopThreeCards_withDuplicateFirstAndSecondIndices_throwsIllegalArgumentException  |
