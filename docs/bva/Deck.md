...
| Test Case 3  | Deck `[card1, card2]`, indices `[0, 1, 2]`                        | `IllegalArgumentException` (Number of indices is larger than the deck size)                         | :white_check_mark: | rearrangeTopThreeCards_TwoInDeckWithThreeIndices_throwsIllegalArgumentException           |
