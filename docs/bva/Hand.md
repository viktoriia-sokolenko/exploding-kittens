...
## Method under test: `removeCardType(CardType cardType)`
### Step 1-3 Results
|        | Input 1                                                            | Input 2                                                                                                | (if more to consider for input)                                                             | Output                                                                                                                                  |
|--------|--------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| Step 1 | a card type                                                        | a card type                                                                                            | the state of the list                                                                       | the state of the list or exception                                                                                                      |
| Step 2 | Cases                                                              | Cases                                                                                                  | Collection                                                                                  | Collection or exception                                                                                                                 |
| Step 3 | null pointer, not in the hand; in the hand once; in the hand twice | NORMAL, EXPLODING_KITTEN, DEFUSE, ATTACK, SKIP, FAVOR, SHUFFLE, SEE_THE_FUTURE, ALTER_THE_FUTURE, NUKE | empty list; list with 1 element; list with more than 1 element; contains duplicate elements | empty list; list with 1 element; list with more than 1 element or NullPointerException, IllegalArgumentException, IllegalStateException |
### Step 4:
|             | System under test (pre-state)                               | Expected output / state transition                                   | Implemented?       | Test name                                                       |
|-------------|-------------------------------------------------------------|----------------------------------------------------------------------|--------------------|-----------------------------------------------------------------|
| Test Case 1 | Hand `[ATTACK]`, cardType `null`                            | `NullPointerException`  ("Card cannot be null")                      | :white_check_mark: | removeCardType_withNullCard_throwsNullPointerException          |
| Test Case 2 | Hand `[]`, cardType `testCard1`                             | `IllegalStateException` (“Hand empty: can not remove card”)          | :white_check_mark: | removeCardType_withEmptyHand_throwsIllegalStateException        |
| Test Case 3 | Hand `[SEE_THE_FUTURE, SHUFFLE]`, cardType `DEFUSE`         | `IllegalArgumentException` (“Card not in hand: can not remove card”) | :white_check_mark: | removeCardType_withCardNotInHand_throwsIllegalArgumentException |
| Test Case 4 | Hand `[testCard2]`, cardType `testCard2`                    | Hand `[]`                                                            | :white_check_mark: | removeCardType_withOneCardInHand_emptiesHand                    |
| Test Case 5 | Hand `[SEE_THE_FUTURE, SHUFFLE]`, cardType `SEE_THE_FUTURE` | Hand `[SHUFFLE]`                                                     | :white_check_mark: | removeCardType_withTwoCardsInHand_removesCard                   |
| Test Case 6 | Hand `[SKIP, NORMAL, NORMAL]`, cardType `NORMAL`            | Hand `[SKIP, NORMAL]`                                                | :white_check_mark: | removeCardType_withDuplicateCardsInHand_removesOnlyOneCard      |
...
| Test Case 4 | Hand `[DEFUSE, SHUFFLE, DEFUSE]` | Hand `[DEFUSE, SHUFFLE]`                                             | :white_check_mark: | removeDefuseCard_withTwoDefuseCardsInHand_removesOnlyOneCard      |
